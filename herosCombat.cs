...
public class herosCombat : MonoBehaviour
{
    ...
    private movementPlayer moveScript;
    private Character statsScript;
    ...
    void Start()
    {
        moveScript = GetComponent<movementPlayer>();
        statsScript = GetComponent<Character>();
